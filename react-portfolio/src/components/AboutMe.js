                ...
                <div class="me-card">
                    <div class="card intro">
                        <div class="card-image col lg2 m3 s12">
                            <img src={Picture} class="db" style={styles.db} alt="Kiri Smith" id="me"></img>
                        </div>

                        <div class="row card-stacked col lg10 m9 s12 background card">
                            <h1>About Me</h1>
                            <h2> I live in Rochester, NY where I attended Nazareth College, receiving a BA in Mathematics and
                                ...
                                portfolio as I create more web applications.</h2>
                        </div>
                    </div>
                </div>
            </div>
